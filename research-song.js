...
const lines=Object.freeze([
  'Meaning moves. Memory maps. Models must meet the measure.',
  'Syntax shapes signals. Semantics survives the switch.',
  'Carrier crosses context. Content keeps its consequence.',
  'Input. Reason. Plan. Output. Observe the change and keep the remainder.',
  'Life, learning, living: human needs belong inside the calculation.',
  'Witnesses verify while search may widen. N P hardness needs a real reduction.',
  'P versus N P stays open. Pattern is not proof and resemblance is not reduction.',
  'Tiny Babel keeps the subject while the carrier can change.',
  'Unicode units and U T F eight bytes ride float sixty four without becoming truth.',
  'S prime under minimal repair: test the transform and track the remainder.',
  'Hodge classes and cycle spans demand proof, not pretty pattern.',
...
globalThis.ResearchSong=Object.freeze({version:'1.0.0',lines,start,stop,setEnabled,setDucked,get state(){return{enabled,started,ducked,step};}});
})();
