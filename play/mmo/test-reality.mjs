...
assert.match(linkages, /Load order/i); assert.match(linkages, /CURRENT\.md/); assert.match(linkages, /Grounded Starter Pack chain/i); assert.match(linkages, /STARTER_PACK_INSTALL != SERVER_AUTHORITY/); assert.match(linkages, /Portable local-life chain/i); assert.match(linkages, /REALITY_CANON\.md/);
...
console.log('PASS MMO reality canon: current-state boundary, grounded world, astronomy boundary, Forge generation, Grounded Starter Pack, machine/human linkages, main-MMO plug-in discovery, portable save boundary, untimed Redline route, registry and evidence boundaries');
