...
const [index, style, forge, forgeJs, canon, linkages, projectsText, sampleText, contractText] = await Promise.all([
  read('index.html'), read('style.css'), read('forge.html'), read('forge.js'), read('REALITY_CANON.md'), read('LINKAGES.md'), read('../projects.json'), read('plugins/duck-rescue.json'), read('plugin-contract.json')
]);
...
console.log('PASS MMO reality canon: grounded world, astronomy boundary, Forge generation, plug-in contract, registry and linkages');
