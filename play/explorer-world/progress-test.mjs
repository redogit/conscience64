...
world.echoes[0].collected=true;world.echoes[3].collected=true;
world.monsters[0].hp=18;world.monsters[1].alive=false;
...
assert.deepEqual(doc.player,{x:1888,y:944,health:73,energy:41});assert.deepEqual(doc.collectedEchoIds,['e0','e3']);assert.deepEqual(doc.regionsSeen,['anomaly','nightbog','sunmeadow']);
